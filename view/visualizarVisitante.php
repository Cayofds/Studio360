...
if ($conn) {
    ...
    if ($stmt = mysqli_prepare($conn, $sql)) {
        ...
        $erroCarregamento = "Não foi possível carregar os visitantes.";
    }
} else {
    ...
    <header class="list-header">
        <div class="container">
            <div>
                ...
                <p>Lista completa dos usuários visitantes com acesso em modo leitura.</p>
            </div>
        ...
        <div class="container">
            ...
            <div class="table-wrapper">
                ...
                <?php elseif (empty($usuarios)): ?>
                    <p class="empty-state">Nenhum visitante cadastrado no momento.</p>
                <?php else: ?>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-cell">
                                            <img src="<?php echo htmlspecialchars(resolveProfileImage($usuario['foto_perfil'] ?? null), ENT_QUOTES, 'UTF-8'); ?>" alt="Foto do visitante">
                                            <div>
