...
if ($conn) {
    ...
    $selectCols = ['id', 'usuario', 'email', 'nivel'];
    ...
    if ($stmt = mysqli_prepare($conn, $sql)) {
        ...
        $erroCarregamento = "Não foi possível carregar a lista de administradores.";
    }
} else {
    ...
    <header class="list-header">
        <div class="container">
            <div>
                ...
                <p>Acompanhe todas as contas com acesso total ao Studio 360.</p>
            </div>
        ...
        <div class="container">
            ...
            <div class="table-wrapper">
                ...
                <?php elseif (empty($usuarios)): ?>
                    <p class="empty-state">Nenhum administrador cadastrado no momento.</p>
                <?php else: ?>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-cell">
                                            <img src="<?php echo htmlspecialchars(resolveProfileImage($usuario['foto_perfil'] ?? null), ENT_QUOTES, 'UTF-8'); ?>" alt="Foto de perfil">
                                            <div>
